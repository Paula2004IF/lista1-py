...
def q13():
    ...
    reajuste = saldo *1.02
    print(f'O {saldo} com reajuste de 2% é {round(reajuste,2)}')
...
def q14():
    base = round(float(input('Digite a base do retângulo: '))) 
    altura = round(float(input('Digite a altura do retângulo: ')))
    ...
    print(f'A área do retângulo é: {área} m²')
    print(f'O perímetro do retângulo é: {perímetro} m')
...
def q16():
    ...
    percentual_de_reajuste = round(float(input('Digite o percentual de reajuste:  ')))

    print(f'O Valor do salário é: R${salario}')
    print(f'O valor de reajuste é: {percentual_de_reajuste}%')
    print(f'O salário ajustado é: R${round(salario+(salario*percentual_de_reajuste/100),2)}')
